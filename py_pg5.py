...
# ->len() 
#   Calcula la logintud de caracteres de una cadena
x = 'Hola mundo'
print('\nlen("', x,'") = ', len(x))
...
# ->replace() 
#   Reeplaza una cadena por otra
x = 'PHP es un gran lenguaje'
print('\n(', x, ').replace("PHP","PYTHON") = ', x.replace('PHP', 'PYTHON'))
...
# ->range() 
#   Crea un rango de números n=numero del rango
x = range(6)
print('\n range(6) = ', list(x))


# str() 
#   convierte un valor númerico a texto
x = 100
print('\n str("100") = ', str(x))
...
# sum() 
#   suma el total de un grupo de números
x = [1, 4, 5, 10]
print('\n sum([1, 4, 5, 10]) = ', sum(x))


# ord() 
#   Devuelve el valor ASCII de una cadena o caracter
x = '@'
print('\n ord(@) = ', ord(x))

# round() 
#   Redondea después de la coma de un float
x = 16.92
y = 16.42
